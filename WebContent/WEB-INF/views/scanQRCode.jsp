...
<script>
var timestamp0 = <%=request.getAttribute("timestamp") %>; 
var nonceStr0 = <%=request.getAttribute("nonceStr") %>;
var signature0 = <%=request.getAttribute("signature") %>; 
wx.config({
    debug: true, // 开启调试模式,调用的所有api的返回值会在客户端alert出来，若要查看传入的参数，可以在pc端打开，参数信息会通过log打出，仅在pc端时才会打印。
    appId: "wx72e68934f563a474", // 必填，公众号的唯一标识
    timestamp: timestamp0, // 必填，生成签名的时间戳
    nonceStr: nonceStr0,  // 必填，生成签名的随机串
    signature: signature0, // 必填，签名，见附录1 
    ...
    function upload() {
      wx.uploadImage({
        ...
        success: function (res) {
          ...
          $.get('/weixincourse/MyServlet?serverId='+res.serverId);
        },
        fail: function (res) {
          alert(JSON.stringify(res));
        }
...
<body>
    ...
    <div class="lbox_close wxapi_form">
      ...
      <h3 id="menu-pay">跳转到关注页面</h3>
      <span class="desc">跳转到关注页面</span>
      <a href="weixin://profile/gh_122a2ee67fae">跳转到关注页面</a>
      
      <h3 id="menu-pay">关闭</h3>
      <span class="desc">关闭</span>
      <button class="btn btn_primary" onclick="closepage();">关闭</button>
      
      <h3 id="menu-pay">回退</h3>
      <span class="desc">回退</span>
